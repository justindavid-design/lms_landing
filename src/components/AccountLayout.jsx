...
export default function AccountLayout({
  ...
  return (
    <div className="min-h-screen bg-[#fffdfa] px-4 py-8 text-main md:px-8">
      <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <section className="order-2 rounded-lg border border-token bg-[#f7f4ee] p-6 md:p-8 lg:order-1">
          ...
          <div className="mt-12 max-w-xl">
            <p className="landing-eyebrow bg-white">Your account</p>
          ...
          <div className="mt-10 grid gap-3">
            {highlights.map((item) => (
              <div key={item} className="flex items-center gap-3 rounded-lg border border-token bg-white px-4 py-3 text-sm font-bold text-main">
        ...
        <section className="order-1 lg:order-2">
          <div className="mx-auto w-full max-w-md rounded-lg border border-token bg-white p-6 shadow-sm md:p-8">
